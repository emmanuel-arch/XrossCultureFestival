...
export function FooterPopup() {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "hello@BirgenAI.com", href: "mailto:hello@BirgenAI.com" },
              ...
              <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start mb-8 gap-4">
                  <div className="flex items-center space-x-4">
                    <img src="/images/logo.png" alt="BirgenAI" className="h-12" />
                    <div>
                ...
                <div className="pt-6 border-t border-border/50">
                  <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
                    <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6">
                      ...
                      <span className="text-sm text-muted-foreground">© 2025 BirgenAI. All rights reserved.</span>
                    </div>
